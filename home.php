                ...
                <div class="col-md-12">
                    <div class="full">
                        <div class="heading_main text_align_center">
                            <h2><span class="theme_color"></span>SELECT</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="full news_blog">
                        ...
                        <div class="overlay"><a class="main_bt transparent" href="Transaction.php">Select</a></div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="full news_blog">
                        ...
                        <div class="overlay"><a class="main_bt transparent" href="#">Select</a></div>
                        <div class="blog_details">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="full news_blog">
                        ...
                        <div class="overlay"><a class="main_bt transparent" href="Transaction_History.php">View</a>
                        </div>
                        <div class="blog_details">
