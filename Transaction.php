...
if (isset($_POST['done'])) {
    ...
    $RecieverAccNo = $_POST['RecieverAccountNo'];
    $SenderName = $_POST['SenderName'];
    $SenderAccNo = $_POST['SenderAccountno'];
    $Amount = $_POST['Amount'];
    $q = "INSERT INTO `transaction`(`RecieverName`, `ReciverAccountNo`, `SenderName`, `SenderAccountNo`, `Amount`) VALUES ('$RecieverName','$RecieverAccNo ','$SenderName','$SenderAccNo',' $Amount')";
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text white_fonts">
                                        ...
                                        <br>
                                        <a class="start_exchange_bt" href="exchange.html">Start Transaction ></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="full">
                                    <div class="heading_main text_align_center">
                                        <h2><span class="theme_color"></span>Enter Details</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6 col-sm-12 offset-lg-3">
                                <div class="full">
                                    <form class="contact_form_inner" method="post">
                                        <fieldset>
                                            <div class="field">
                                                <input type="text" name="RecieverName" placeholder="TO" />
                                            </div>
                                            <div class="field">
                                                <input type="text" name="RecieverAccountNo"
                                                    placeholder="Reciever Account#" />
                                            </div>
                                            <div class="field">
                                                <input type="text" name="SenderName" placeholder="From" />
                                            </div>
                                            <div class="field">
                                                <input type="text" name="SenderAccountno"
                                            ...
                                            <div class="footer_blog full white_fonts">
                                                ...
                                                <div class="newsletter_form">
                                                    <form action="index.html">
                                                        <input type="email" placeholder="Your Ema
                                     i                      l" name="#" required="">
                                        ...
                                        <div class="full">
                                            <div class="footer_blog full white_fonts">
                                                ...
                                                <ul class="full">
                                                    ...
                                                    <li><img src="images/i5.png"><span>London 145<br>United
                                                            Kingdom</span></li>
