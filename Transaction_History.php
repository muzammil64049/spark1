            ...
            <div class="row">
                ...
                <table id="tabledata" class=" table table-striped table-hover table-bordered">
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            <?php echo $res['RecieverName']; ?>
                        </td>
                        <td>
                            <?php echo $res['ReciverAccountNo']; ?>
                        </td>
                        <td>
                            <?php echo $res['SenderName']; ?>
                        </td>
                        <td>
                            <?php echo $res['SenderAccountNo']; ?>
                        </td>
                        <td>
                            <?php echo $res['Amount']; ?>
                        </td>
                        <!-- <td> <button class="btn-danger btn"> <a href="delete.php?_ID=<?php echo $res['_ID']; ?>"
                                class="text-white">
                                Delete </a> </button> </td>
                    <td> <button class="btn-primary btn"> <a href="Update.php?_ID=<?php echo $res['RecieverName']; ?>"
                                class="text-white">
                                Update </a> </button> </td> -->
